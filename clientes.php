                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-8 col-md-6 col-sm-12">
                            <button type="button" class="btn btn-info btn-rounded" style="float:right;" @click="abrirModal('cliente','registrar')">
                                Nuevo Cliente
                            </button>
                            <div class="btn-group mr-3" style="float:right;" v-if="sesion[0].IDUSUARIO==3 || sesion[0].IDUSUARIO ==15 || sesion[0].IDUSUARIO ==28 || sesion[0].IDUSUARIO ==58 || sesion[0].IDUSUARIO ==73">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" target="_top" v-bind:href="'modelo/clientes/reporte.php?id='+sesion[0].IDEMPLEADO">Descargar Cliente</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <template v-if="$.trim(entradas.length)>=1")>
                                    <tr  v-for="entrada in entradas">
                                        ...
                                        <td style="text-transform:lowercase;">{{entrada.eMail}}</td>
                                        <td>{{entrada.NOM_EMPLE}}</td>
                                        <td v-if="entrada.archivo" title="Click para descargar" v-tippy="{ position : 'top',  arrow: true, size: 'small' }" style="cursor:pointer;" class="text-center"><a v-bind:href="'files/archivosclientes/'+entrada.archivo" download alt=""><i class="fa fa-download" style="font-size: 2rem;"></i></a></td>
                                        <td v-else class="text-center" title="Sin archivo adjunto" v-tippy="{ position : 'top',  arrow: true, size: 'small' }" style="cursor:pointer;"><i class="fas fa-exclamation-circle" style="font-size: 2rem;"></i></td>
                                        <td class="text-nowrap"> 
                                            <a href="javascript:void(0)" title="Editar" v-tippy="{ position : 'top',  arrow: true, size: 'small' }" class="edit" @click="abrirModal('cliente','actualizar',entrada)"> <i class="fas fa-pencil-alt text-inverse m-r-10"></i> </a>
                                            <a href="javascript:void(0)" v-if="sesion[0].IDUSUARIO==15 || sesion[0].IDUSUARIO==28 || sesion[0].IDUSUARIO ==58 || sesion[0].IDUSUARIO ==73" title="Eliminar" v-tippy="{ position : 'top',  arrow: true, size: 'small' }" @click="eliminar(entrada.idPersona)" > <i class="fas fa-window-close text-danger"></i> </a>
                                        </td>
                                    </tr>
                                </template>
                                <template v-else>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <div v-show="error">
                                    <div v-for="err in errorcategoria" :key="err" v-text="err" class="errorcamp"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Tipo cliente</label>
                                <select class="form-control" v-model="tipoCliente">
                                    <option value="">SELECCIONE TIPOC.</option>
                                ...
                                <div v-show="error">
                                    <div v-for="err in errortipoCliente" :key="err" v-text="err" class="errorcamp"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Razón social - Nombres</label>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Razón comercial - Apellidos</label>
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Cedula/RUC</label>
                                <input type="text" class="form-control solonumeros" v-model="cedulaRuc" id="ruc" onKeyPress="return soloNumeros(event)" maxlength="13">
                                <div v-show="error">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" style="text-transform: lowercase;" v-model="eMail">
                                <div v-show="error">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Subir un archivo</label>
                                <input type="file" @change="subiearchivo" class="form-control-file" id="exampleFormControlFile1">
                            </div>
                        </div>
                    </div>
                </div>
...
?> 
<script src="static/js/vueclientes.js"></script> 
</div>
</body>
</html>