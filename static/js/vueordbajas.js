var app = new Vue({
    ...
    methods: {
        listar() {
            let me = this;
            axios({
                url: "modelo/ordbajas/listar.php",
                method: "get",
                params: {
                    'buscar':this.buscar, 
                    'hj':this.hj,
        ...
        eliminar(id, idp, cantidad, creado,lugar,iddetop,idop) {
            let me = this;
            swal({
                title: "Seguro deseas eliminar esta Baja?",
                text:"la baja se eliminará de la base y la cantidad regresará al stock/OP",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            }).then((willDelete) => {
                if (willDelete) {
                    axios({
                        url: "modelo/ordbajas/eliminar.php",
                        method: "get",
                        params: {
                            'id':id,
                            'idp':idp,
