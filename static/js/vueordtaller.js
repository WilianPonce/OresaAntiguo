var app = new Vue({
    ...
    methods: {
        listar() {
            let me = this;
            axios({
                url: "modelo/ordtaller/listar.php",
                method: "get",
                params: {
                    'buscar':this.buscar,
                    'hj':this.hj,
        ...
        guardartaller(entrada){
            this.idOrdPedido = entrada;
            let me = this;
            swal({
                ...
                if (willDelete) {
                    axios({
                        url: "modelo/ordtaller/aprobartaller.php",
                        method: "get",
                        params: {
                        ...
                        if($.trim(respuesta.data) == 'error'){
                            alertify.error('Error en este ingreso');  
                        }else{
                            me.listar();
                            alertify.success('trabajo terminado');
                        }
                    });
                }
            });
