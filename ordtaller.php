...
?>
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Orden de Taller</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Inicio</a></li>
                <li class="breadcrumb-item active">OrdTaller</li>
            </ol>
        </div>
                            ...
                            <tbody>
                                <template v-if="entradas.length">
                                    <tr  v-for="entrada in entradas">
                                        ...
                                        <td class="text-center p-0" v-else>
                                        ...
                                        <td class="text-nowrap text-center">
                                            ...
                                            <a href="javascript:void(0)" v-if="entrada.terminado!=1" @click="abrirModal('ordtrabajo','actualizar',entrada)" title="Agregar Trabajador/es" v-tippy="{ position : 'top',  arrow: true, size: 'small' }"> <i class="fas fa-users text-inverse m-r-4" style="font-size: 18px;"></i> </a>
                                            <a href="javascript:void(0)" v-if="entrada.terminado!=1" @click="guardartaller(entrada.idOrdPedido)" title="Trabajo terminado" v-tippy="{ position : 'top',  arrow: true, size: 'small' }"> <i class="fas fa-check text-inverse" style="font-size: 16px;"></i> </a>
                                        </td>
                                    </tr>
                                </template>
                                <template v-else>
...
?> 
<script src="static/js/vueordtaller.js"></script>
</div>
</body>
</html> 